                ...
                {exercises.map(exercise => {
                  return (
                    <ListItem key={exercise.id}>
                      <ListIcon
                        as={
                          exercise.type[0] === 'Cardio' ? FaRunning : FaDumbbell
                        }
                        color="green"
                      />
                      ...
                      <List>
                        ...
                        {exercise.liftingWeight && (
                          <ListItem fontSize="small">
                            Lift weight: {exercise.liftingWeight}
                          </ListItem>
                        )}
                        {exercise.sets && (
                          <ListItem fontSize="small">
                        ...
                        {exercise.calories && (
                          <ListItem fontSize="small">
                            Calories burnt: {exercise.calories}
                          </ListItem>
                        )}
                      </List>
                    </ListItem>
